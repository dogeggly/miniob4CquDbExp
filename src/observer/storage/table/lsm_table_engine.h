...
public:
  ...
  RC create_vector_index(Trx *trx, const FieldMeta *field_meta, const char *index_name, const char *distance_method,
      int lists, int probes) override { return RC::UNIMPLEMENTED; }
